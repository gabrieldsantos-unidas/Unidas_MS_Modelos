  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        const processedData: LocaviaCores[] = jsonData.map((row: any) => ({
          CodigoModelo: String(row['CodigoModelo'] || '').trim(),
          AnoModelo: String(row['AnoModelo'] || '').trim(),
          Name: String(row['Name'] || '').trim(),
          IRIS_Cor_ID__c: String(row['IRIS_Cor_ID__c'] || '').trim(),
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        const processedData: SalesForceCores[] = jsonData.map((row: any) => ({
          IRIS_Codigo_Modelo_Locavia_Integracao__c: String(row['IRIS_Dispositvo__r.IRIS_Codigo_Modelo_Locavia_Integracao__c'] || row['IRIS_Codigo_Modelo_Locavia_Integracao__c'] || '').trim(),
          IRIS_Codigo_do_Modelo_do_Locavia__c: String(row['IRIS_Dispositvo__r.IRIS_Codigo_do_Modelo_do_Locavia__c'] || row['IRIS_Codigo_do_Modelo_do_Locavia__c'] || '').trim(),
          ...
          IRIS_Cor_ID__c: String(row['IRIS_Cor__r.IRIS_Cor_ID__c'] || row['IRIS_Cor_ID__c'] || '').trim(),
          ProductCode_Cor: String(row['IRIS_Cor__r.ProductCode'] || row['ProductCode_Cor'] || '').trim(),
          IRIS_Valor__c: row['IRIS_Valor__c'] !== undefined && row['IRIS_Valor__c'] !== null && row['IRIS_Valor__c'] !== ''
